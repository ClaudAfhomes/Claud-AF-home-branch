...
function FooterEditor({ notify }: { notify: (message: string) => void }) {
  const [config, setConfig] = useAdminDraft(() => cmsRepository.getSiteConfig());
  const fields: Array<[keyof SiteConfig, string, boolean?]> = [
    ["footerEyebrow", "Footer eyebrow"], ["footerTitle", "Footer headline", true],
    ["footerNoticeTitle", "Notice title"], ["footerNoticeBody", "Notice text", true],
    ["footerCopyright", "Copyright text"], ["footerExploreLabel", "Explore column label"],
    ["footerExperiencesLabel", "Experiences column label"], ["footerContactLabel", "Contact column label"],
